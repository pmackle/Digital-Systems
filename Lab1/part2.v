...
//=======================================================
//Extremely simple test with LEDs and logic
module part2(
...
assign HEX0[3] = ( ( (~SW[3])&(SW[2])&(~SW[1])&(~SW[0]) ) | ( (~SW[2])&(~SW[1])&(SW[0]) ) | ( (SW[3])&(~SW[2])&(SW[0]) ) | ( (~SW[3])&(SW[2])&(SW[1])&(SW[0]) ) | ( (SW[3])&(SW[2])&(SW[1])&(~SW[0]) ) ); 
assign HEX0[4] = ( (SW[0]) | ( (~SW[3])&(SW[2])&(~SW[1]) ) | ( (SW[3])&(SW[2])&(SW[1]) ) );
assign HEX0[5] = ( ( (SW[3])&(SW[2])&(~SW[1]) ) | ( (~SW[2])&(SW[1])&(SW[0]) ) | ( (~SW[3])&(SW[1])&(SW[0]) ) | ( (~SW[3])&(~SW[2])&(SW[0]) ) | ( (~SW[3])&(~SW[2])&(SW[1]) ) );
